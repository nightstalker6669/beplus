...
public class Add extends EcoCommand {
    ...
    public void run(CommandSender sender, String[] args) {
        ...
        sender.sendMessage(ChatColor.GREEN + "[Economy] Added $" + amt + " to " + name + ". They now have $" + SettingsManager.getInstance().getBalance(name) + ".");
        target.sendMessage(ChatColor.GREEN + "[Economy] " + p.getName() + "gave you " + amt + ".");
